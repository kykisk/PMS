...
export function MultiScenarioGenerateModal({ open, onClose, projectId }: Props) {
  ...
  return (
    <Modal open={open} onClose={handleClose} title="다중 AI 테스트 시나리오 생성" className="max-w-4xl">
            ...
            <div className="flex-1 flex flex-col p-4 gap-3">
              ...
              <div>
                <div className="flex items-center justify-between mb-1">
                  ...
                  <span className="text-[10px] text-gray-400">{detailLevel <= 3 ? '간략' : detailLevel <= 7 ? '보통' : '상세'} (~{detailLevel}개)</span>
                </div>
