...
export const exportApi = {
  ...
  testResult: (projectId: string, cycleId: string) =>
    fetchExcel(`/projects/${projectId}/export/test-result?cycleId=${cycleId}`, 'test-result.xlsx'),
  testResultPivot: (projectId: string) =>
    fetchExcel(`/projects/${projectId}/export/test-result-pivot`, 'test-result-pivot.xlsx'),
  defectReport: (projectId: string) =>
    fetchExcel(`/projects/${projectId}/export/defect-report`, 'defect-report.xlsx'),
  requirementsPdf,
  wbsPdf,
  rtmPdf,
  testPlanPdf,
